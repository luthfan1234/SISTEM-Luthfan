    ...
    <main class="flex flex-col px-20 w-full max-md:px-5 max-md:max-w-full">
      ...
      <div class="flex gap-5 max-md:flex-col">
        <article class="flex flex-col w-3/12 max-md:w-full hover:text-white">
          <a href="/business" class="flex flex-col p-8 w-full border border-solid border-zinc-500 max-md:px-5 max-md:mt-8 transition duration-150 ease-in-out hover:bg-blue-600 hover:text-white">
